package net.sytes.botg.array.string;

import net.sytes.botg.array.math.Scalar;

/**
 * implementation of the docker name generator
 * @see https://github.com/moby/moby/blob/39f7b2b6d0156811d9683c6cb0743118ae516a11/pkg/namesgenerator/names-generator.go#L852-L863
 * @author hillenbrand
 *
 */
public class NameGenerator {
	...
	public static String random() {
		String left = LEFT_PART[Scalar.randInt(0, LEFT_PART.length - 1)];
		String right = RIGHT_PART[Scalar.randInt(0, RIGHT_PART.length - 1)];
		return left + "_" + right;
	}
